...
```html
<button class="transition-colors duration-300 bg-[#ff006e] text-white px-4 py-2 md:px-6 md:py-3">
  点击我
</button>
```
...
<div class="rounded-sm transition-colors p-6 md:p-8">
  <h3 class="font-light tracking-wide text-lg md:text-xl">标题</h3>
</div>
```
...
```html
<input class="bg-transparent focus:outline-none px-3 py-2 md:px-4 md:py-3" placeholder="请输入..." />
```
